...
Para más información sobre los dispositivos IoT disponibles, consulte el [catálogo de dispositivos certificados para IoT](https://catalog.azureiotsolutions.com/alldevices) más grande del sector.
